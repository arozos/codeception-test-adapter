...
- 🧪 **Native Test Explorer Integration** - Tests appear in VSCode's Testing sidebar with the test beaker icon
- 🔍 **Automatic Test Discovery** - Automatically finds all Test, Cest, and Cept files in your project
- ▶️ **Run Individual Tests** - Click the play button next to any test method, file, or suite
- 📊 **Suite Organization** - Tests organized by Codeception suites (unit, functional, acceptance)
- 🔄 **Auto-refresh** - Tests automatically update when you save files
- 🎯 **Run at Any Level** - Execute entire suites, individual files, or specific test methods
- 🐳 **Docker Support** - Run tests inside Docker containers with automatic working directory detection
- 📈 **Code Coverage** - Built-in support for test coverage visualization and reporting
- 💻 **CodeLens Integration** - Run and debug tests directly from your code editor
- ⚙️ **Flexible Configuration** - Customize test execution with configurable paths, arguments, and suites
...
4. Click the ▶️ play button next to any test/file/suite to run it
...
- Click ▶️ next to a suite to run all tests in that suite
- Click ▶️ next to a file to run all tests in that file
- Click ▶️ next to a test method to run just that test
